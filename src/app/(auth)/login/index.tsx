     ...
     <View className="w-full flex-1 items-center justify-center">
        ...
        <View className="bg-white py-10 px-4 w-96 rounded-xl">
          <View className="flex gap-2 mb-4">
            <Text className="text-center font-bold text-lg text-brand-primary-1">Acesse sua conta!</Text>
            <Text className="text-center text-brand-gray-1">Seu app de leitura para criar hábito e muitas conquistas</Text>
          </View>

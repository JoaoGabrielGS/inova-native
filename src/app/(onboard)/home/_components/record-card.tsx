    ...
    <View className="rounded-xl w-full bg-brand-grey-9 p-0 mb-6 overflow-hidden" style={styles.card}>
      ...
      <View className="px-3 pb-4">
        <View className='flex-row mb-2 mt-3 items-start gap-4 justify-between'>
          <View style={styles.badge} className='bg-brand-grey-10 px-2 rounded-full overflow-hidden uppercase'>
            <Text className='text-white font-semibold'>{course.type.name}</Text>
          </View>

          <View className='flex-row items-center gap-4'>
            <Text className='text-white text-lg'>{HelpersUtils.formatDurationHHMM(course.durationInMinutes)}hs</Text>
        ...
        <View className='mt-6 gap-3'>
          <Button text="Assistir Aulas" icon={play} />
